...
function createDevTools(children) {
  ...
  return _temp = _class = /*#__PURE__*/function (_Component) {
    (0, _inherits2.default)(DevTools, _Component);
    ...
    store: _propTypes.default.object
  }), (0, _defineProperty2.default)(_class, "instrument", function (options) {
    return (0, _instrument.instrument)(function (state, action) {
